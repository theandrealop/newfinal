...
async function testGraphQLEndpoint() {
  ...
  try {
    ...
    const response = await fetch('https://new-punti-furbi-draft-815f04.ingress-florina.ewp.live/graphql', {
      method: 'POST',
      headers: {
...
async function simulateRateLimiting() {
  ...
  for (let i = 0; i < 5; i++) {
    promises.push(
      fetch('https://new-punti-furbi-draft-815f04.ingress-florina.ewp.live/graphql', {
        method: 'POST',
