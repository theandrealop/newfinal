...
export const metadata: Metadata = {
  title: 'Trova il miglior pacchetto eSIM per il tuo prossimo viaggio | Punti Furbi',
  description: 'Confronta prezzi, copertura e caratteristiche di tutti i principali provider eSIM. Trova la tariffa più conveniente per la tua destinazione.',
  ...
  openGraph: {
    title: 'Trova il miglior pacchetto eSIM per il tuo prossimo viaggio',
    description: 'Confronta prezzi, copertura e caratteristiche di tutti i principali provider eSIM. Trova la tariffa più conveniente per la tua destinazione.',
    type: 'website',
  },
  alternates: {
    canonical: 'https://puntifurbi.com/esim'
  }
}
