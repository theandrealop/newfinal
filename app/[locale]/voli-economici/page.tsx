...
export default function VoliEconomiciPage() {
  const t = useTranslations('VoliEconomici');
...
const manualOffers = [
  ...
  },
  {
    ...
    discount: 54,
    dates: "Settembre 2025",
    airline: "Norse Atlantic Airways",
    stops: "Diretto",
    duration: "9h 30m",
    description: "Volo non-stop Roma–New York A/R a soli 273€!",
    image_url: "photo-1496442226666-8d4d0e62e6e9",
    status: "active",
    booking_url: "https://trip.tpk.mx/4Sqmh8ag"
  },
  {
    id: 16,
    origin: "Milano",
    ...
    discount: 48,
    dates: "Date variabili, solo uno scalo (lungo a Shanghai)",
    airline: "Vari vettori",
    stops: "1 scalo (lungo a Shanghai)",
    duration: "24h+",
    description: "Dall’Italia a Australia e Nuova Zelanda a soli 725€! Perfetto per stopover gratuito a Shanghai.",
    image_url: "photo-1506973035872-a4ec16b8e8d9",
    status: "active",
    booking_url: "https://trip.tpk.mx/X5QrGOZK"
  },
  {
    id: 18,
    origin: "Roma",
    ...
    discount: 54,
    dates: "Halloween 2025, combinazioni flessibili",
    airline: "Vari vettori",
    stops: "1 scalo (alcune tratte stopover a Shanghai)",
    duration: "14h+",
    description: "Giappone a poco più di 400€ A/R! Ottima occasione per Halloween, anche stopover a Shanghai.",
    image_url: "photo-1540959733332-eab4deabeeaf",
    status: "active",
    booking_url: "https://trip.tpk.mx/qh9ZDfpP"
  },
  {
    id: 19,
    origin: "Milano",
    ...
    discount: 66,
    dates: "Dicembre 2025 - Gennaio 2026 (escluso Natale/Capodanno)",
    airline: "easyJet",
    stops: "Diretto",
    duration: "4h 30m",
    description: "Egitto A/R da 69€! Milano - Luxor, volo non-stop con easyJet.",
    image_url: "photo-1562679299-266edbefd6d7",
    status: "active",
    booking_url: "https://bit.ly/3TZxK26"
  },
  ...
  return (
    <div className="min-h-screen bg-cream">
      ...
      <section className="py-16 lg:py-24 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 text-center relative z-10">
          <h1 className="text-4xl lg:text-6xl font-bold mb-6 text-dark-green">
            <span className="text-[#483cff]">{t('title')}</span>
          </h1>
      ...
      <section className="py-16 lg:py-24 bg-light-green">
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl lg:text-5xl font-bold mb-4 text-dark-green">{t('activeOffers')}</h2>
            <p className="text-xl text-gray-700">{t('activeOffers')}</p>
          </div>
      ...
      <section className="py-16 lg:py-24">
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl lg:text-5xl font-bold mb-4 text-dark-green">{t('featuredOffers')}</h2>
            <p className="text-xl text-gray-700">{t('featuredSubtitle')}</p>
          </div>
      ...
      <section className="py-16 lg:py-24">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="text-3xl lg:text-5xl font-bold mb-6 text-dark-green">
            {t('dontMiss')} <span className="text-[#483cff]">{t('dontMiss')}</span>
          </h2>
